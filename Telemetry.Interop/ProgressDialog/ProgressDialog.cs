...
namespace ProgressDialogs {
	...
	public class ProgressDialog : Component {
		...
		/// </summary>
		[DefaultValue(""), Browsable(true), Category("Appearance"), Description("First line of text")]
		public string Line1 {
			get {
				return _line1;
			}
		...
		/// </summary>
		[DefaultValue(""), Browsable(false), Category("Appearance"), Description("Second line of text")]
		public string Line2 {
			get {
				return _line2;
			}
		...
		/// </summary>
		[DefaultValue(""), Browsable(false), Category("Appearance"), Description("Third line of text")]
		public string Line3 {
			get {
				return _line3;
			}
